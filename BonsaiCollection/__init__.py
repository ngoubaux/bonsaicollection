...
import logging
logger = logging.getLogger('BonsaiCollection')
...
DirectoryView.registerDirectory('skins/BonsaiCollection',
                                    product_globals)
...
def initialize(context):
    ...
    if CustomizationPolicy and hasattr(CustomizationPolicy, 'register'):
        ...
        print 'Customization policy for BonsaiCollection installed'
